...
const selectClassList = 'block bg-slate-100 text-slate-900 text-sm rounded-lg outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 w-full p-2.5 appearance-none cursor-pointer';
