const arrowClassList = 'after:content-["▼"] after:text-xs after:block after:absolute after:right-2.5 after:top-1/2 after:-translate-y-1/2 after:text-slate-400 after:pointer-events-none';
